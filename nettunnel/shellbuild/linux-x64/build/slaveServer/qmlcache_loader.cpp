...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qml/TurnServer.qml"), &QmlCacheGeneratedCode::_qml_TurnServer_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qml/Weather.qml"), &QmlCacheGeneratedCode::_qml_Weather_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qml/MComboBox.qml"), &QmlCacheGeneratedCode::_qml_MComboBox_qml::unit);
