    ...
    , ui(new Ui::WeatherWidget)
{
    ...
    connect(&Weather::getInstance(), &Weather::queryFinish, this,
            [ = ](WeatherInfo& winfo, QString& errormessage) {
        qdebug << errormessage;
...
void WeatherWidget::insertText(QString         text,
...
void WeatherWidget::on_pushButtonp_clicked()
{
    ...
    ui->plainTextEdit->clear();
    QString str;
    str = QString("日期:%1 %2").arg(m_winfo.data[currentIndex].date).arg(
        m_winfo.data[currentIndex].week);
    insertText(str, ui->plainTextEdit, 16, QColor("#1a1b1c"), QColor("#a0a0a0"));
...
void WeatherWidget::on_pushButtony_clicked()
{
    ...
    ui->plainTextEdit->clear();
    QString str;
    str = QString("日期:%1 %2").arg(m_winfo.yesterdaydata.date).arg(
        m_winfo.yesterdaydata.week);
    insertText(str, ui->plainTextEdit, 16, QColor("#1a1b1c"), QColor("#a0a0a0"));
