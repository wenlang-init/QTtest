...
//属性 get 函数 (在qml可直接调用)
#define PROP_GET_QML(T, NAME) Q_INVOKABLE MEM_GET(T, NAME)
...
// 可读可写 属性。属性set函数 提升为 slot 总是会发出改变信号，可被 invok / qml 调用
#define AUTO_PROPERTY_ALWAYS(T, NAME, InitValue)                                                                                                                      \
private:                                                                                                                                                       \
    Q_PROPERTY(T NAME READ NAME WRITE set_##NAME NOTIFY NAME##Changed)                                                                                         \
    public:                                                                                                                                                        \
    PROP_GET(T, NAME);                                                                                                                                         \
    Q_SLOT PROP_SET_ALWAYS(T, NAME);                                                                                                                                  \
    PROP_CHANGE(T, NAME);                                                                                                                                      \
    \
    private:                                                                                                                                                       \
    PROP_MEM(T, NAME, InitValue)
