...
MapGraphicsView3::MapGraphicsView3(QWidget *parent)
    : QGraphicsView(parent)
{
    ...
    connect(GetUrlInterface::getInterface(),
            &GetUrlInterface::update,
            this,
            &MapGraphicsView3::drawImg);
}

MapGraphicsView3::~MapGraphicsView3() {}

void MapGraphicsView3::setRect(int level)
{
 ...
 * @param info
 */
void MapGraphicsView3::drawImg(const ImageInfo& info)
{
...
void MapGraphicsView3::mousePressEvent(QMouseEvent *event)
{
 ...
 * @param event
 */
void MapGraphicsView3::mouseReleaseEvent(QMouseEvent *event)
{
 ...
 * @param event
 */
void MapGraphicsView3::wheelEvent(QWheelEvent *event)
{
    m_pos = event->position();                      // 鼠标相对于窗口左上角的坐标
    m_scenePos = this->mapToScene(m_pos.toPoint()); // 鼠标在场景中的坐标
 ...
 * @param event
 */
void MapGraphicsView3::resizeEvent(QResizeEvent *event)
{
 ...
 * @param event
 */
void MapGraphicsView3::showEvent(QShowEvent *event)
{
 ...
 */
void MapGraphicsView3::getShowRect()
{
    QRect  rect;
