...
Rectangle {
    ...
    FontLoader {
        id: iconFont
        source: "qrc:/src/layout/resource/fontawesome-free-6.7.2-desktop/otfs/Font Awesome 6 Free-Solid-900.otf"
    }
    ...
    Components.EAvatar {
        ...
        avatarSource: "qrc:/src/layout/resource/pic/avatar.png"
        MouseArea {
            anchors.fill: parent
