...
GLImageWindow::GLImageWindow(QWindow *parent) :
...
void GLImageWindow::loadImage(const QImage& image)
{
...
void GLImageWindow::resizeGL(int w, int h)
{
    glViewport(0, 0, w, h);
}

void GLImageWindow::getModelScale(float            & scaleWidth,
                                  float            & scaleHeight,
...
void GLImageWindow::setupShaders()
{
...
void GLImageWindow::setupGeometry()
{
...
void GLImageWindow::createTexture(const QImage& image)
{
