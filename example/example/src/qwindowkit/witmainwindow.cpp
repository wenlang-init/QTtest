...
WitMainWindow::WitMainWindow(QWidget *parent)
    : QMainWindow(parent) {
    installWindowAgent();
...
bool WitMainWindow::event(QEvent *event) {
    switch (event->type()) {
...
void WitMainWindow::closeEvent(QCloseEvent *event) {
...
void WitMainWindow::installWindowAgent() {
    ...
    auto menuBar = [this]() {
                       ...
                       // Theme action
                       auto darkAction = new QAction(tr("Enable dark theme"),
                                                     menuBar);
            ...
            loadStyleSheet(checked ? Dark : Light); //
                       ...
                       connect(this, &WitMainWindow::themeChanged, darkAction,
                               [this, darkAction]() {
            darkAction->setChecked(currentTheme == Dark); //
        });

#ifdef Q_OS_WIN
                       auto dwmBlurAction = new QAction(tr("Enable DWM blur"),
                                                        menuBar);
                       dwmBlurAction->setCheckable(true);
                       connect(dwmBlurAction, &QAction::toggled, this,
                               [this](bool checked) {
            ...
            style()->polish(this);
                       ...
                       connect(acrylicAction, &QAction::toggled, this,
                               [this](bool checked) {
            ...
            style()->polish(this);
                       ...
                       connect(micaAction, &QAction::toggled, this,
                               [this](bool checked) {
            ...
            style()->polish(this);
                       ...
                       auto micaAltAction = new QAction(tr("Enable mica alt"),
                                                        menuBar);
                       micaAltAction->setCheckable(true);
                       connect(micaAltAction, &QAction::toggled, this,
                               [this](bool checked) {
            ...
            style()->polish(this);
                       ...
                       auto darkBlurAction =
                           new QAction(tr("Dark blur"), menuBar);
                       darkBlurAction->setCheckable(true);
                       connect(darkBlurAction, &QAction::toggled, this,
                               [this](bool checked) {
            ...
            if (checked) {
                ...
                style()->polish(this);
                       ...
                       auto lightBlurAction = new QAction(tr("Light blur"),
                                                          menuBar);
                       lightBlurAction->setCheckable(true);
                       connect(lightBlurAction, &QAction::toggled, this,
                               [this](bool checked) {
            if (!windowAgent->setWindowAttribute(QStringLiteral("blur-effect"),
                                                 "light")) {
                return;
            ...
            if (checked) {
                ...
                style()->polish(this);
                       ...
                       connect(noBlurAction, &QAction::toggled, this,
                               [this](bool checked) {
            if (!windowAgent->setWindowAttribute(QStringLiteral("blur-effect"),
                                                 "none")) {
                return;
...
void WitMainWindow::loadStyleSheet(Theme theme) {
