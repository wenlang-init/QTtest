...
public:
    ...
    explicit AVEncoderThread(const QString& outputFile,
        ...
        // connect(this, &AVEncoderThread::finish, this,
        // &AVEncoderThread::quit);
        // connect(this,
        //         &AVEncoderThread::finished,
        //         this,
        //         &AVEncoderThread::deleteLater);
        // start();
    }
    ...
    void run() override
    {
        ...
        if (!m_usedUpdate) {
            ...
            for (int i = 0; i < m_audioList.size(); i++) {
                std::vector<int16_t>& audio = m_audioList.first();
