...
class CustomBtn : public BaseWidget
{
    Q_OBJECT
public:
    explicit CustomBtn(QWidget *parent = NULL,QString img_url="",QString text="button");

    void setimage(QString img_url);
    void settext(QString text);

    void settext_fontcolor(QFont textfont = QFont("Microsoft Yahei", 10, QFont::Normal),QColor textColor = Qt::black);
...
public slots:
    void Key_Pass_Slot(int key,int index); // 按键槽函数
};
